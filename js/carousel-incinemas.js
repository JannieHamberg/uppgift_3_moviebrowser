function fetchinCinemas() {
    const apiKey = '03b494ebe50361cd87fe561b366ff9d4';
    const cinemasUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=${apiKey}&language=en-US&page=1`;
    ...
    .then(data => {
        ...
        const carousel = document.querySelector('#inCinemasCarousel .carousel-inner');
...
document.addEventListener('DOMContentLoaded', fetchinCinemas);