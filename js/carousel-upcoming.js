function fetchUpcomingMovies() {
    ...
    fetch(upcomingUrl)
      ...
      .then(data => {
        ...
        const carouselInner = document.querySelector('#upcomingMoviesCarousel .carousel-inner');
  ...
  function displayError() {
    const carousel = document.querySelector('#upcomingMoviesCarousel .carousel-inner');
    if (carousel) {
        carousel.innerHTML = `
